...
import { SALE2, STEP2 } from '../utils/consts'
...
const QuizSale = () => {
  ...
  const {setValues, data} = useData()
    ...
    return (
        ...
        <MainContainer>
            <Typography variant="h4" component="h2">Укажите ваши контакные данные</Typography>
...
<Button className='w-100 mt-3' variant='success' type= 'submit' >Далее</Button>
            </Form>
        </MainContainer>
