...
const AllSale = () => {
    ...
    useEffect(() =>{
        fetch('http://localhost:5000/api/buyreq')
   ...
   .then(rowData => setRowData(rowData))
    ...
    {headerName: "Этаж", field: 'floor',resizable: true },
    {headerName: "Площадь", field: 'square',resizable: true  },
    {headerName: "Ремонт", field: 'remont' ,resizable: true},
    {headerName: "Тип дома", field: 'typeHome',resizable: true },
    {headerName: "Цена", field: 'price',resizable: true },
